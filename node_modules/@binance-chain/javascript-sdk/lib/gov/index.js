            ...
            switch (_context.prev = _context.next) {
              case 0:
                listTradingPairObj = {
                  ...
                  init_price: +new _big.default(listParams.initPrice).mul(Math.pow(10, 8)).toString(),
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                coins = [{
                  denom: 'BNB',
                  amount: new _big.default(initialDeposit).mul(Math.pow(10, 8)).toString()
                }];
                votingPeriod = +new _big.default(votingPeriod).mul(Math.pow(10, 8)).toString();
                proposalMsg = {
                  title: title,
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                coins.forEach(function (coin) {
                  amount.push({
                    denom: coin.denom,
                    amount: +new _big.default(coin.amount).mul(Math.pow(10, 8)).toString()
                  });
                });
                depositMsg = {
